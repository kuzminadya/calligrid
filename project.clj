(defproject calligrid "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "calligrid.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main calligrid.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "calligrid.core/on-figwheel-reload"}

                :compiler {:main calligrid.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/calligrid.js"
